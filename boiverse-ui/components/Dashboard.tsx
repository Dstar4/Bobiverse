    ...
    <Row align="top" style={{minHeight: '80vh'}}>
      <Col>
        {bobs.map(bob => (
          <div>
            <h3>
              <strong>Name:</strong> {bob.name}
            </h3>
            <p>
              <strong>Minerals:</strong> {bob.minerals || '0'}
            </p>
            <p>
            ...
            <p>
              <strong>Location [x,y,z]</strong>:{' '}
              {JSON.stringify(Object.values(bob.coordinates))}
            </p>
            <Divider />
            <h3>Drones</h3>
            {bob.drones.map(drone => (
              <div>
                ...
                <p>
                  <strong>Drone Target:</strong> {drone.target_id}
                </p>
                <p>
                  <strong>Job Complete At:</strong> {drone.job_complete_at}
                </p>
                <p>
                  <strong>Size:</strong> {drone.size}
                </p>
              </div>
            ))}
            <Divider />
